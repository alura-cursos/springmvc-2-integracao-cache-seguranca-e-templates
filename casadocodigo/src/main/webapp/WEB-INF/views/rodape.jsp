  ...
  <footer id="layout-footer">
    <div class="clearfix container">
      ...
      <div id="social-footer"><!-- books-footer -->
         ...
         <ul class="footer-text-links">
          <li><a href="http://www.galandra.com.br" target="_blank">Galandra - Reforce seu inglês</a></li>
          ...
          <li><a href="https://www.caelum.com.br" target="_blank">Caelum - Ensino e Inovação</a></li>
      ...
      <div id="newsletter-footer"><!-- social-footer -->
        ...
        <ul class="footer-payments">
          <li><img class="accepts-paypal" src="//cdn.shopify.com/s/files/1/0155/7645/t/177/assets/accepts_paypal.png?5935512085070205644" border="0" alt="Paypal" width="130" height="80"/></li>
          <li><img class="accepts-pagseguro" src="//cdn.shopify.com/s/files/1/0155/7645/t/177/assets/logopagseguro.png?5935512085070205644" border="0" alt="PagSeguro" width="180" height="26"/></li>
        </ul>
      </div>
    </div>
  </footer>
